...
To install just rename the old ones to something else and download and put the folders in your ~/.config folder. Or, if your on arch, use the install script.

You will need to install hyprland, hyprpanel, kitty and nwg-drawer.

nwg-dock-hyprland and waybar are deprecated, but I will leave the configs here if you want them.
